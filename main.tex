...
\vspace{0.2em}
\begin{center}
{\small \textit{Seeking full-time Research Scientist positions starting Spring/Fall 2027}}
\end{center}
\vspace{-0.3em}
% =====================================================
...
\vspace{0.2em}
{\small
Bayesian deep learning; trustworthy AI; scalable variational inference; uncertainty quantification for neural networks; low-rank and structured approximations; time-series foundation models; graph neural networks; molecular machine learning; out-of-distribution detection; AI for health, AI for science.
}
...
{
    \item Coursework: Stochastic Calculus, Monte Carlo Methods, Numerical Analysis, Optimization, Statistical Modeling, Partial Differential Equations, Deep Learning, Stochastic Control, Derivatives Pricing, Interest Rate Modeling.
...
{\textcolor{theme}{Accepted at UAI 2026} $\cdot$ \href{https://arradiat.github.io/projects/per-class-epistemic/}{project page}}
{{\textbf{M.\ D.\ Toure}}, D.\ A.\ Stephens.
...
{https://openreview.net/forum?id=zo49sqP8xD}
...
{\small
\begin{itemize}[leftmargin=1.2em, nosep, label=\tiny$\bullet$, itemsep=1pt]
\item \textbf{Time-series foundation models:} Scaling the SBNN framework to uncertainty-aware time-series foundation models, including low-rank Bayesian adaptation of pretrained Transformer encoders (MOMENT, Chronos, TimesFM) and data-driven per-layer rank selection based on the Vendi Score of pre-activations. Target applications include demand forecasting under distributional shift and urban mobility prediction, where calibrated predictive distributions support inventory, routing, and fleet planning decisions.
\item \textbf{Molecular graph neural networks:} Developing end-to-end low-rank Bayesian GNNs for uncertainty-aware molecular property prediction under scaffold shift. The project studies whether over-specified GINE architectures can reveal smaller viable low-rank Bayesian models, using spectral compressibility diagnostics, tapered layerwise rank allocation, embedding compression, rank-calibrated priors, and uncertainty–cost evaluation against deterministic GNNs, full MFVI Bayesian GNNs, SWAG, Deep ensembles, and post-hoc UQ baselines.
\end{itemize}
}
...
\vspace{0.3em}
\vspace{0.3em}
\noindent \textbf{\href{https://ism.uqam.ca/scholarships/}{ISM Scholarship for Outstanding PhD Candidates}} \hfill Winter 2027 \\
...
\vspace{0.3em}
\noindent \textbf{Not Just How Much, But Where: Decomposing Epistemic Uncertainty into Per-Class Contributions} \hfill August 2026 \\
{\small Conference on Uncertainty in Artificial Intelligence (UAI 2026), Amsterdam, Netherlands.}
